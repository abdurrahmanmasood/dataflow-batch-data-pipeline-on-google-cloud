...
input_data_location = "gs://data_lake_<name>/yellow_tripdata_{}.parquet".format(date.today())
output_table = "<project_id>:nyctaxi.yellow_tripdata"
schema = """VendorID:STRING,
tpep_pickup_datetime:DATETIME,
tpep_pickup_datetime_day:INTEGER,
tpep_pickup_datetime_month:INTEGER,
tpep_pickup_datetime_year:INTEGER,
tpep_dropoff_datetime:DATETIME,
tpep_dropoff_datetime_day:INTEGER,
tpep_dropoff_datetime_month:INTEGER,
tpep_dropoff_datetime_year:INTEGER,
...
def process_columns(element):
    data = {}
    data['VendorID'] = "Creative Mobile Technologies, LLC" if element['VendorID'] == 1 else "VeriFone Inc." if element['VendorID'] == 2 else None
    data['tpep_pickup_datetime'] = element['tpep_pickup_datetime']
    data['tpep_pickup_datetime_day'] = element['tpep_pickup_datetime'].day
    data['tpep_pickup_datetime_month'] = element['tpep_pickup_datetime'].month
    data['tpep_pickup_datetime_year'] = element['tpep_pickup_datetime'].year
    data['tpep_dropoff_datetime'] = element['tpep_dropoff_datetime']
    data['tpep_dropoff_datetime_day'] = element['tpep_pickup_datetime'].day
    data['tpep_dropoff_datetime_month'] = element['tpep_pickup_datetime'].month
    data['tpep_dropoff_datetime_year'] = element['tpep_pickup_datetime'].year
